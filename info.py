...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002154482696 -1001767486774 -1002304474918 -1001779982100').split()]  # Channel id for auto indexing (make sure bot is admin)
