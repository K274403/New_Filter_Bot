...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002154482696 -1001767486774 -1002304474918 -1001779982100 -1002192042126').split()]  # Channel id for auto indexing (make sure bot is admin)
...
DATABASE_URI2 = environ.get('DATABASE_URI2' ,"mongodb+srv://Deepak:Deepak@cluster0.gq9gf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
