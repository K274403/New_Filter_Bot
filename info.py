...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002154482696 -1002304474918').split()]  # Channel id for auto indexing (make sure bot is admin)
