...
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/dcB.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1798348973 6661494944').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002154482696 -1001767486774 -1002304474918 -1002617794966 -1001779982100 -1002192042126').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002186335716'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002186335716'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002081004430'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002186335716'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002023191399')  # Channel/Group ID for force sub (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002081004430')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002023191399').split()]
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/QqQ.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'rkmovieszip@ybl')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI' ,"mongodb+srv://Vishal:Vishal@cluster0.knlsaek.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2' ,"mongodb+srv://RAMU:RAMU@cluster0.tqf7qm5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002263971223'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/KrishFilmy/1860')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '1c63c44f09e1aaa3135bcdcf93423b532bf7e786')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/KrishFilmy/1860')  # Tutorial video link for opening shortlink website
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/rkmoviezip')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+GkGB4jgvSoFjZTg1')  # Support group link (make sure bot is admin)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002263971223')).split()]
